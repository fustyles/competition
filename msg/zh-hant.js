...
Blockly.Msg["JAVASCRIPT_CREATE_FUNCTION_EXIST_SCRATCH"] = "函式名稱已存在，自動修改名稱";
...
Blockly.Msg["TEST_CODE_CHECK"] = "工作區必須只有一個輸出積木並置於程式的結尾，取消評測！";
Blockly.Msg["TEST_DATA_JSON_ERROR"] = "評測JSON資料格式錯誤，取消評測！";
Blockly.Msg["BUTTON_GEMINI_API_KEY"] = "輸入Gemini API金鑰";
...
Blockly.Msg["IMPORTQUESTION_SHEET_ID_TITLE"] = "試算表共用連結(代碼)";
...
Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] = "已存在名為「%1」，且用於其它類型的變數。";
