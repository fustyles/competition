...
Blockly.Msg["TEST_CODE"] = "执行测资";
Blockly.Msg["TEST_DATA"] = "测资数据";
Blockly.Msg["TEST_RUNNING"] = "程式执行中...";
Blockly.Msg["TEST_CODE_TEST"] = "测资：%1";
Blockly.Msg["TEST_CODE_CORRECT"] = "输出：%1 🟢";
Blockly.Msg["TEST_CODE_ERROR"] = "输出：%1 🔴";
Blockly.Msg["TEST_CODE_CORRECT_COUNT"] = "答对数";
Blockly.Msg["TEST_CODE_MESSAGE"] = "请填入测试数据 %1，以分号符号(;)分隔要输入与输出的连续数据。\n若不填数据送出即可停止输入。";
Blockly.Msg["TEST_CODE_CHECK"] = "工作区必须只有一个输出积木并置于程式的结尾，取消测资！";
Blockly.Msg["TEST_DATA_JSON_ERROR"] = "测资JSON资料格式错误，取消测资！";
Blockly.Msg["BUTTON_GEMINI_API_KEY"] = "输入Gemini API金钥";
Blockly.Msg["BUTTON_UPLOAD_CODE"] = "试题内容";
Blockly.Msg["BUTTON_SHOW_CODE"] = "试题内容 显示/隐藏";
...
Blockly.Msg["IMPORTQUESTION_HEADER"] = "汇入题目与测资数据";
...
Blockly.Msg["BUTTON_CODE"] = "试题内容 显示/隐藏";
...
Blockly.Msg["GEMINI_CHAT"] = "对话";
Blockly.Msg["GEMINI_KEY"] = "金钥";
