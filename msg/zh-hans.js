...
Blockly.Msg["JAVASCRIPT_CREATE_FUNCTION_EXIST_SCRATCH"] = "函式名称已存在，执行取消"
Blockly.Msg["JAVASCRIPT_START_ALERT_SCRATCH"] = "工作区必须有一个启动程式积木，执行取消！";
Blockly.Msg["JAVASCRIPT_CONNECT_MESSAGE_SCRATCH"] = "此积木只能连接到函式类型的积木串中。";
