...
,mySwitch$$module$build$src$generators$javascript$logic=
function(a,b){
	var value=b.valueToCode(a,"VALUE",Order$$module$build$src$generators$javascript$javascript_generator.NONE)||""
	var f=0,c="switch ("+value+") {\n";
	b.STATEMENT_PREFIX&&(c+=b.injectId(b.STATEMENT_PREFIX,a));
	do{
		var d=b.valueToCode(a,"CASE"+f,Order$$module$build$src$generators$javascript$javascript_generator.NONE)||"";
		//d=d.replace(/"/g,"'");
		var e=b.statementToCode(a,"DO"+f)||"";
		b.STATEMENT_SUFFIX&&(e=b.prefixLines(b.injectId(b.STATEMENT_SUFFIX,a),b.INDENT)+e);
		c+="  case "+d+":\n";
		c+=e!=""?"  "+e.replace(/\n/g,"\n  ")+"  break;\n":"    break;\n";
		++f
	}while(a.getInput("CASE"+f));
	if(a.getInput("DEFAULT")||b.STATEMENT_SUFFIX) {
		e=b.statementToCode(a,"DEFAULT")
		,b.STATEMENT_SUFFIX&&(e=b.prefixLines(b.injectId(b.STATEMENT_SUFFIX,a),b.INDENT)+e)
		c+="  default:\n";
		c+=e!=""?"  "+e.replace(/\n/g,"\n  ")+"  break;\n":"    break;\n";		
	}
...
d&&!d.suppressPrefixSuffix&&(c+=b.injectId(b.STATEMENT_PREFIX,d))}switch(a.getFieldValue("FLOW")){case "BREAK":return c+"break;\n";case "CONTINUE":return c+"continue;\n"}throw Error("Unknown flow statement.");},math_number$$module$build$src$generators$javascript$math=function(a,b){a=Number(a.getFieldValue("NUM"));return[a,0<=a?Order$$module$build$src$generators$javascript$javascript_generator.ATOMIC:Order$$module$build$src$generators$javascript$javascript_generator.UNARY_NEGATION]},math_arithmetic$$module$build$src$generators$javascript$math=
...
"null",c+=b.INDENT+"return "+a+";\n"):c+=b.INDENT+"return;\n";return c+"}\n"},text$$module$build$src$generators$javascript$text=function(a,b){return[b.quote_(a.getFieldValue("TEXT")),Order$$module$build$src$generators$javascript$javascript_generator.ATOMIC]},text_noquotes$$module$build$src$generators$javascript$text=function(a,b){if (isNaN(a.getFieldValue("TEXT"))) {var text = b.quote_(a.getFieldValue("TEXT"));} else {var text = a.getFieldValue("TEXT");}return[text,Order$$module$build$src$generators$javascript$javascript_generator.ATOMIC]},text_multiline$$module$build$src$generators$javascript$text=function(a,b){a=b.multiline_quote_(a.getFieldValue("TEXT"));b=-1!==a.indexOf("+")?Order$$module$build$src$generators$javascript$javascript_generator.ADDITION:Order$$module$build$src$generators$javascript$javascript_generator.ATOMIC;
...
finish(a){
	...
	const f=Object.values(this.functions_);
...
module$build$src$generators$javascript$logic.controls_if=controls_if$$module$build$src$generators$javascript$logic;module$build$src$generators$javascript$logic.controls_ifelse=controls_if$$module$build$src$generators$javascript$logic;


module$build$src$generators$javascript$logic.mySwitch=mySwitch$$module$build$src$generators$javascript$logic;
...
module$build$src$generators$javascript$text.text_replace=text_replace$$module$build$src$generators$javascript$text;module$build$src$generators$javascript$text.text_reverse=text_reverse$$module$build$src$generators$javascript$text;module$build$src$generators$javascript$text.text_trim=text_trim$$module$build$src$generators$javascript$text;var module$build$src$generators$javascript$variables={};module$build$src$generators$javascript$variables.variables_get=variables_get$$module$build$src$generators$javascript$variables;
...
module$build$src$generators$javascript$variables.variables_set_local=variables_set_local$$module$build$src$generators$javascript$variables;
var module$build$src$generators$javascript$variables_dynamic={};module$build$src$generators$javascript$variables_dynamic.variables_get_dynamic=variables_get$$module$build$src$generators$javascript$variables;module$build$src$generators$javascript$variables_dynamic.variables_set_dynamic=variables_set$$module$build$src$generators$javascript$variables;var javascriptGenerator$$module$build$src$generators$javascript=new JavascriptGenerator$$module$build$src$generators$javascript$javascript_generator;
